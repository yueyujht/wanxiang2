package cn.wanxing.device.state.mapper;
...
public interface DeviceStateMapper extends BaseMapper<DeviceState> {
     ...
     */
    @Insert("INSERT INTO sys_device_state (device_sn, state_json, firmware_version, alarm_state, drone_in_dock, cover_state, mode_code, firmware_upgrade_status, updated_at) "
            + "VALUES (#{deviceSn}, #{stateJson}, #{firmwareVersion}, #{alarmState}, #{droneInDock}, #{coverState}, #{modeCode}, #{firmwareUpgradeStatus}, NOW()) "
